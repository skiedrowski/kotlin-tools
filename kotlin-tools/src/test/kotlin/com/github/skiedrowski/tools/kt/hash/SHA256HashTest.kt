...
class SHA256HashTest {
    ...
    @Test
    fun hashPlaintext1() {
        checkSHA256("Franz jagt im komplett verwahrlosten Taxi quer durch Bayern",
                "d32b568cd1b96d459e7291ebf4b25d007f275c9f13149beeb782fac0716613f8")
    }

    @Test
    fun hashPlaintext2() {
        checkSHA256("Frank jagt im komplett verwahrlosten Taxi quer durch Bayern",
    ...
    @Test
    fun hashPlaintext4() {
        checkSHA256("The quick brown fox jumps over the lazy dog",
    ...
    private fun checkSHA256(plaintext: String, expHash: String) {
        ...
        assertThat("emptySalt", hashEmptyStringSalt, equalTo(expHash))
        ...
        if (plaintext.length > 6) {
            ...
            assertThat("withSalt", hashWithSalt, equalTo(expHash))
        }
        assertThat(expHash.length, equalTo(64))
    }
}
